/*
If the data members of the Base class are Protected and the mode of Inheritance is Public then, the inherited data members in subclass will be Protected.
